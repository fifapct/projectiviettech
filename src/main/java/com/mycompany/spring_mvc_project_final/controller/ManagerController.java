...
//    --------ROOM CATEGORY MANAGEMENT--------    
    ...
    public String doneUpdateRoomCategory(Model model, HttpSession session,
        ...
        int ids =(int) session.getAttribute("id");
        if (result.hasErrors()) {
            model.addAttribute("action", "update");
        ...
        String uploadRootPath = "C:\\Users\\LENOVO\\Documents\\NetBeansProjects"
                + "\\Spring_MVC_Project_Final\\src\\main\\webapp\\resources\\upload\\room_category";
    ...
    public String doneAddService(Model model,
        ...
        String uploadRootPath = "C:\\Users\\LENOVO\\Documents\\NetBeansProjects"
                + "\\Spring_MVC_Project_Final\\src\\main\\webapp\\resources\\upload\\service";
        File uploadRootDir = new File(uploadRootPath);
...
//-----------PROMOTION MANAGEMENT--------
    ...
    public String doneAddPromotion(Model model,
        ...
        String uploadRootPath = "C:\\Users\\LENOVO\\Documents\\NetBeansProjects"
                + "\\Spring_MVC_Project_Final\\src\\main\\webapp\\resources\\upload\\promotion";
        File uploadRootDir = new File(uploadRootPath);
